            ...
            <template v-slot:header>
              <div class="row align-items-center">
                <div class="col">
                  ...
                  <h3 class="nav-link-text text-center ls-1 mb-1 h3">提交编译</h3>
                </div>
              </div>
            </template>
            <div class="row">
            ...
            <template v-slot:header>
              <div class="row align-items-center">
                <div class="col">
                  ...
                  <h3 class="nav-link-text text-center ls-1 mb-1 h3">编译状态</h3>
                </div>
              </div>
            </template>
            <div class="row">
                  <div class="col-12" v-for="(site,index) in joblist" :key="site[0]" >
                    <card header-classes="bg-transparent" v-if="index>=5*(value-1) && index<5*value">
                        <div class="row">
                            ...
                            <center class="col-12 text-primary" v-else-if="site[1]==2">
                                Pending
                            </center>
                            <center class="col-12 text-success" v-else-if="site[1]==3">
                                Success
                            </center>
                            ...
                            <div class="form-control-label col-7">
                              ...
                              <div class="col text-right">
                                  <base-button size="sm" type="info" class="row" :disabled="site[1]!=3" @click="downloadEvt('http://202.38.79.96:18887/'+site[0]+'/results/top.bit')" outline >
                              ...
                              <div class="col text-right"  >
                                  <base-dropdown  tag="base-button" position="left" size="sm" type="info" class="row" outline >
                                    ...
                                    <a class="dropdown-item" :href="'http://202.38.79.96:18887/'+site[0]+'/compiling.log'">compiling.log</a>
                                    <a class="dropdown-item" :href="'http://202.38.79.96:18887/'+site[0]+'/results/timing.rpt'" v-if="site[1]==3">timing.rpt</a>
                                    <a class="dropdown-item" :href="'http://202.38.79.96:18887/'+site[0]+'/results/util.rpt'" v-if="site[1]==3">util.rpt</a>
                                  </base-dropdown>
                              </div>
                              <div class="col text-right">
              ...
              <div class= "col-12 mt-2">
                <base-pagination align="center" :total='this.joblist.length' :perPage='5' :value="value" @input="receive" ></base-pagination>
              </div>
